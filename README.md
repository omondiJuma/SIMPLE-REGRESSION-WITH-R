On this repository I have two csv data files that I used to test simple regression with R. One file is for fuel prices where I tested the effect of crude oil on the fuel price.
